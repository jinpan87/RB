					...
					<div class="well">
						...
						<div id="myCarousel-2" class="carousel slide">
							...
							<div class="carousel-inner">
								...
								<!-- Slide 2 -->
								<div class="item">
									<img src="lib/smartadmin/img/demo/m1.jpg" alt="">
								...
								<!-- Slide 3 -->
								<div class="item">
									<img src="lib/smartadmin/img/demo/m2.jpg" alt="">
				...
				<div class="col-sm-12 col-md-12 col-lg-6">
					...
					<div class="well">
						...
						<div class="text-center">
							<img src="lib/smartadmin/img/demo/demo-smartbig-alert.png" alt="demo" class="img-responsive">
						</div>
				...
				<div class="col-sm-12 col-md-12 col-lg-6">
					...
					<div class="well">
						...
						<ul class="demo-btns text-center">
							...
							<li>
								<a href="javascript:void(0);" class="lib/smartadmin/btn btn-default btn-lg" rel="tooltip" data-placement="top" data-original-title="<img src='lib/smartadmin/img/avatars/sunny.png' alt='me' class='online'>" data-html="true">also Image</a>
							</li>
						</ul>
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-12 col-lg-6">
			...
			<div class="well">
				...
				<ul class="media-list">
					<li class="media">
						<a class="pull-left" href="javascript:void(0);"> <img class="media-object" alt="64x64" src="lib/smartadmin/img/demo/64x64.png"> </a>
...
<script type="text/javascript">
	...
	loadScript("lib/smartadmin/js/plugin/bootstrap-progressbar/bootstrap-progressbar.js", progressBarAnimate);
