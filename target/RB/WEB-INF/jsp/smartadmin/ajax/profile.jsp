				...
				<div class="row">
									...
									<div id="myCarousel" class="carousel fade profile-carousel">
										...
										<div class="carousel-inner">
											...
											<div class="item active">
												<img src="lib/smartadmin/img/demo/s1.jpg" alt="">
											</div>
											<!-- Slide 2 -->
											<div class="item">
												<img src="lib/smartadmin/img/demo/s2.jpg" alt="">
											</div>
											<!-- Slide 3 -->
											<div class="item">
												<img src="lib/smartadmin/img/demo/m3.jpg" alt="">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-12">
									...
									<div class="row">
										...
										<div class="col-sm-3 profile-pic">
											<img src="lib/smartadmin/img/avatars/sunny-big.png">
										...
										<div class="col-sm-3">
											...
											<ul class="list-inline friends-list">
												<li><img src="lib/smartadmin/img/avatars/1.png" alt="friend-1">
												</li>
												<li><img src="lib/smartadmin/img/avatars/2.png" alt="friend-2">
												</li>
												<li><img src="lib/smartadmin/img/avatars/3.png" alt="friend-3">
												</li>
												<li><img src="lib/smartadmin/img/avatars/4.png" alt="friend-4">
												</li>
												<li><img src="lib/smartadmin/img/avatars/5.png" alt="friend-5">
												</li>
												<li><img src="lib/smartadmin/img/avatars/male.png" alt="friend-6">
												</li>
												<li>
											...
											<ul class="list-inline friends-list">
												<li><img src="lib/smartadmin/img/avatars/male.png" alt="friend-1">
												</li>
												<li><img src="lib/smartadmin/img/avatars/female.png" alt="friend-2">
												</li>
												<li><img src="lib/smartadmin/img/avatars/female.png" alt="friend-3">
												</li>
											</ul>
										...
										<div class="tab-content padding-top-10">
											...
											<div class="tab-pane fade" id="a2">
												...
												<div class="user" title="email@company.com">
													<img src="lib/smartadmin/img/avatars/female.png"><a href="javascript:void(0);">Jenn Wilson</a>
													<div class="email">
														travis@company.com
													</div>
												</div>
												<div class="user" title="email@company.com">
													<img src="lib/smartadmin/img/avatars/male.png"><a href="javascript:void(0);">Marshall Hitt</a>
													<div class="email">
														marshall@company.com
													</div>
												</div>
												<div class="user" title="email@company.com">
													<img src="lib/smartadmin/img/avatars/male.png"><a href="javascript:void(0);">Joe Cadena</a>
													<div class="email">
														joe@company.com
													</div>
												</div>
												<div class="user" title="email@company.com">
													<img src="lib/smartadmin/img/avatars/male.png"><a href="javascript:void(0);">Mike McBride</a>
													<div class="email">
														mike@company.com
													</div>
												</div>
												<div class="user" title="email@company.com">
													<img src="lib/smartadmin/img/avatars/male.png"><a href="javascript:void(0);">Travis Wilson</a>
													<div class="email">
														travis@company.com
													</div>
												</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-6">
						...
						<div class="chat-body no-padding profile-message">
							<ul>
								<li class="message">
									<img src="lib/smartadmin/img/avatars/sunny.png" class="online">
								...
								<li class="message message-reply">
									<img src="lib/smartadmin/img/avatars/3.png" class="online">
								...
								<li class="message message-reply">
									<img src="lib/smartadmin/img/avatars/4.png" class="online">
						...
						<div class="chat-body no-padding profile-message">
							<ul>
								<li class="message">
									<img src="lib/smartadmin/img/avatars/1.png" class="online">
