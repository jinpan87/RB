...
<script type="text/javascript">
	 ...
	 * SUMMERNOTE EDITOR
	 */
	loadScript("lib/smartadmin/js/plugin/summernote/summernote.js", summernoteStart);
	...
	loadScript("lib/smartadmin/js/plugin/markdown/markdown.min.js", loadToMarkdown);
	
	function loadToMarkdown (){
		loadScript("lib/smartadmin/js/plugin/markdown/to-markdown.min.js", loadBSMarkdown);
	}
	
	function loadBSMarkdown(){
		loadScript("lib/smartadmin/js/plugin/markdown/bootstrap-markdown.min.js", markdownStart);
	}
