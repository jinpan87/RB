...
<script type="text/javascript">
	 ...
	 */
	loadScript("lib/smartadmin/js/plugin/bootstrap-wizard/jquery.bootstrap.wizard.min.js", runBootstrapWizard);
	 ...
	 */
	loadScript("lib/smartadmin/js/plugin/fuelux/wizard/wizard.js", fueluxWizard);
