...
<script type="text/javascript">
	...
	function loadDataTableScripts() {
		...
		loadScript("lib/smartadmin/js/plugin/datatables/jquery.dataTables-cust.min.js", dt_2);

		function dt_2() {
			loadScript("lib/smartadmin/js/plugin/datatables/ColReorder.min.js", dt_3);
		}

		function dt_3() {
			loadScript("lib/smartadmin/js/plugin/datatables/FixedColumns.min.js", dt_4);
		}

		function dt_4() {
			loadScript("lib/smartadmin/js/plugin/datatables/ColVis.min.js", dt_5);
		}

		function dt_5() {
			loadScript("lib/smartadmin/js/plugin/datatables/ZeroClipboard.js", dt_6);
		}

		function dt_6() {
			loadScript("lib/smartadmin/js/plugin/datatables/media/js/TableTools.min.js", dt_7);
		}

		function dt_7() {
			loadScript("lib/smartadmin/js/plugin/datatables/DT_bootstrap.js", runDataTables);
		}
	...
	function runDataTables() {
		...
		$('#datatable_tabletools').dataTable({
			...
			"oTableTools" : {
				...
				"sSwfPath" : "lib/smartadmin/js/plugin/datatables/media/swf/copy_csv_xls_pdf.swf"
			},
			"fnInitComplete" : function(oSettings, json) {
