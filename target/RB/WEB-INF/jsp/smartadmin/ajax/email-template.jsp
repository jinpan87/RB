...
<div class="row">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
			<img src="lib/smartadmin/img/demo/basic.png" alt="Basic Email Template" style="width:100%; height:auto;">
			<br>
			<br>
		...
		<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
			<img src="lib/smartadmin/img/demo/sidebar.png" alt="Sidebar Email Template" style="width:100%; height:auto;">
			<br>
			<br>
		...
		<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
			<img src="lib/smartadmin/img/demo/hero.png" alt="Hero Email Template" style="width:100%; height:auto;">
			<br>
			<br>
		...
		<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
			<img src="lib/smartadmin/img/demo/sidebarhero.png" alt="Sidebar with Hero" style="width:100%; height:auto;">
			<br>
			<br>
		...
		<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
			<img src="lib/smartadmin/img/demo/newsletter.png" alt="Newsletter Email Template" style="width:100%; height:auto;">
			<br>
			<br>
