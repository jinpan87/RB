...
var pagefunction = function() {
      ...
      $("#soption_addSoption_form_0").validate({
        ...
        submitHandler: function(form) {
        	...
        	/* alert("pName："+pName+"pCode："+pCode+"pManager："+pManager+"pProvince："+pProvince+
        			"pCity："+pCity+"pCounty："+pCounty+"pGrew："+pGrew+"pSummary："+pSummary+"pState:"+pState+"pOverCause:"+pOverCause); */
