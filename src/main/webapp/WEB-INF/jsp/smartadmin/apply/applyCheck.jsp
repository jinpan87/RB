...
var editRow=function(id,proposerInt){
	 
		window.location.hash="apply/checkUpdateApply.do?id="+id+"&aProposer="+proposerInt+"&aApprover=${userId}";
		...
		jQuery("#jqgrid").jqGrid({
			...
			gridComplete: function(){
				...
				for(var i=0;i < ids.length;i++){
					...
					be = "<button class='btn btn-xs btn-default' title='审批' onclick=\"editRow('"+id+"','"+proposerInt+"');\"><i class='fa fa-pencil'></i></button>"; 
