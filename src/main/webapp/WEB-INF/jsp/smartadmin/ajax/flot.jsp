...
<script type="text/javascript">
	...
	function loadFlotResize() {
		loadScript("lib/smartadmin/js/plugin/flot/jquery.flot.resize.js", loadFlotFillbetween);
	}
	function loadFlotFillbetween() {
		loadScript("lib/smartadmin/js/plugin/flot/jquery.flot.fillbetween.js", loadFlotOrderBar);
	}
	function loadFlotOrderBar() {
		loadScript("lib/smartadmin/js/plugin/flot/jquery.flot.orderBar.js", loadFlotPie);
	}	
	function loadFlotPie() {
		loadScript("lib/smartadmin/js/plugin/flot/jquery.flot.pie.js", loadFlotToolTip);
	}
	function loadFlotToolTip() {
		loadScript("lib/smartadmin/js/plugin/flot/jquery.flot.tooltip.js", generateAllFlotCharts);
	}
