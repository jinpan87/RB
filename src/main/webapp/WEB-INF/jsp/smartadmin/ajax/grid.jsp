...
<div class="row">
	...
	<div class="col-sm-3">
		...
		<img src="lib/smartadmin/img/demo/responseimg.png" style="max-width:300px; width:100%;">
		<p>
			<br>
			<h3>BuiltWith Bootstrap</h3>
			Bootstrap is made to not only look and behave great in the latest desktop browsers, 
			but in tablet and smartphone browsers too. Itâs packed with great features. Such as the 12-column responsive mobile first grid, 
		...
		<table class="table table-bordered table-striped">
			<thead>
				<tr>
					...
					<th> Small devices <small>Tablets (â¥768px)</small></th>
					<th> Medium devices <small>Desktops (â¥992px)</small></th>
					<th> Large devices <small>Desktops (â¥1200px)</small></th>
				</tr>
			</thead>
			<tbody>
				<tr>
