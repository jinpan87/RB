							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<input id="range-slider-2" type="text" name="range_2" value="1000;100000" data-type="double" data-step="500" data-postfix=" â¬" data-from="30000" data-to="90000" data-hasgrid="true">
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	...
	$("#spinner-currency").spinner({
	 ...
	 //Maxlength
	loadScript("lib/smartadmin/js/plugin/maxlength/bootstrap-maxlength.min.js", runMaxLength);
	...
	loadScript("lib/smartadmin/js/plugin/bootstrap-timepicker/bootstrap-timepicker.min.js", runTimePicker);
	...
	loadScript("lib/smartadmin/js/plugin/noUiSlider/jquery.nouislider.min.js", noUiSlider);
	 ...
	 * ION SLIDER
	 */
	loadScript("lib/smartadmin/js/plugin/ion-slider/ion.rangeSlider.min.js", ion_slider);
	 ...
	 * COLOR PICKER
	 */
	loadScript("lib/smartadmin/js/plugin/colorpicker/bootstrap-colorpicker.min.js", initializeColorpicker);
	...
	loadScript("lib/smartadmin/js/plugin/bootstrap-tags/bootstrap-tagsinput.min.js");


	/*
	 * KNOB
	 */
	loadScript("lib/smartadmin/js/plugin/knob/jquery.knob.min.js", startKnob);
	...
	loadScript("lib/smartadmin/js/plugin/x-editable/moment.min.js", loadMockJax);

	function loadMockJax() {
	    loadScript("lib/smartadmin/js/plugin/x-editable/jquery.mockjax.min.js", loadXeditable);
	}

	function loadXeditable() {
	    loadScript("lib/smartadmin/js/plugin/x-editable/x-editable.min.js", loadTypeHead);
	}

	function loadTypeHead() {
	    loadScript("lib/smartadmin/js/plugin/typeahead/typeahead.min.js", loadTypeaheadjs);
	}

	function loadTypeaheadjs() {
	    loadScript("lib/smartadmin/js/plugin/typeahead/typeaheadjs.min.js", runXEditDemo);
	}
