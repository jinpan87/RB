...
<script type="text/javascript">
	...
	loadScript("lib/smartadmin/js/plugin/morris/raphael.2.1.0.min.js", loadMorrisEngine);
	// Load morris dependency 2
	function loadMorrisEngine() {
		loadScript("lib/smartadmin/js/plugin/morris/morris.min.js", runMorrisCharts);
	}
