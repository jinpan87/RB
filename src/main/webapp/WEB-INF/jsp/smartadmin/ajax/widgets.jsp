...
<section id="widget-grid" class="">
	...
	<div class="row">
		...
		<article class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					...
					<div class="widget-body">
						...
						<div class="row">
							...
							<div class="col-md-6 col-lg-4">
								<img src="lib/smartadmin/img/demo/widget-colorpicker.png" alt="widget colorpicker" class="pull-right hover-transparent img-responsive"> 
							</div>
			...
			<!-- Widget ID (each widget will need unique ID)-->
			<div class="jarviswidget" id="wid-id-13" data-widget-load="demowidget.do" data-widget-colorbutton="false" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false">
				<!-- widget options:
					usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
