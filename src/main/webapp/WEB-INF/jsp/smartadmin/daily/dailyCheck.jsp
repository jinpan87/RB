 ...
 var editRow=function(id){
	...
	var roleId='${roleId}';
	 $.post("daily/dailyUpdate.do",{id:id,rState:"${userName}"},function(data){
		...
		alert("更新成功");
		/* $.post("daily/dailyCheck.do",{roleId:"roleId",userName:"data.userName",userId:"userId"},function(data){
			$('#width_jqgrid').html(data);
		}
				); */
		 window.location.hash="daily/dailyCheck.do?roleId="+roleId+"&userName="+data.userName+"&userId="+userId;
