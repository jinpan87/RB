...
<body class="fixed-navigation fixed-header fixed-ribbon">
	...
	<aside id="left-panel">
		...
		<nav>
			...
			<ul>
			    <li class="active">
					<a href="myPage.do" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">我的测试页面</span></a>
				</li>
				<li class="">
				...
				<li>
					...
					<ul>
						<li>
							<a href="flot.do">Flot图表</a>
						</li>
						<li>
							<a href="morris.do">Morris图表</a>
						</li>
						<li>
				...
				<li>
					...
					<ul>
						<li>
							<a href="table.do">普通表格</a>
						</li>
						<li>
							<a href="dataTables.do">数据表格</a>
						</li>
					</ul>
				</li>
				<li>
